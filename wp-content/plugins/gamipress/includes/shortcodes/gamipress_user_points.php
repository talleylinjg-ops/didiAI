    ...
    gamipress_register_shortcode( 'gamipress_user_points', array(
        ...
        'fields'      => array(
            ...
            'current_user' => array(
                ...
                'tooltip'   => __( 'Show points earned by the current logged in user.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
                'default'   => 'yes',
            ...
            'user_id' => array(
                ...
                'tooltip'   => __( 'Show points earned by a specific user.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'select',
                'default'   => '',
            ...
            'period' => array(
                ...
                'tooltip'   => __( 'Filter points balance based on a specific period selected. By default "None" that will display user current points balance.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'select',
            ...
            'wpms' => array(
                ...
                'tooltip'   => __( 'Show user points from all network sites.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
            'hide_no_earnings' => array(
                ...
                'tooltip'   => __( 'Hide the point balance if no earnings.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
