    ...
    gamipress_register_shortcode( 'gamipress_points', array(
        ...
        'fields'      => array(
            ...
            'current_user' => array(
                ...
                'tooltip'   => __( 'Show only points earned by the current logged in user.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
            'user_id' => array(
                ...
                'tooltip'   => __( 'Show only points earned by a specific user. Leave blank to show the site points (points sum of all users).', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'select',
                'default'   => '',
            ...
            'period' => array(
                ...
                'tooltip'   => __( 'Filter points balance based on a specific period selected. By default "None" that will display user or site current points balance.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'select',
