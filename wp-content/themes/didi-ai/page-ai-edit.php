      ...
      <div class="card">
        <div id="chatcutPanel" style="display:none;margin-bottom:16px;border:1px solid #5eead4;border-radius:12px;padding:16px;background:#f0fdfa;">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
            <p style="font-size:15px;font-weight:700;color:#0d9488;margin:0;">ChatCut 智能剪辑 · 唯一工具</p>
            <span class="badge success" id="chatcutStatusBadge">未连接</span>
          </div>
          <div id="chatcutDisconnected">
            <p style="font-size:13px;color:#0f766e;line-height:1.8;">ChatCut 是视频剪辑的唯一工具，排列在剪辑指令之前。点击「授权连接 ChatCut 账号」，登录并授权后即可使用 ChatCut 的 <b>52</b> 个剪辑工具，以及 <b>对话 / 语音 / 图片 / 文件上传</b> 四种剪辑方式。</p>
            <button type="button" class="btn" id="btn-connect-chatcut" style="margin-top:10px;border-color:#14b8a6;color:#0d9488;">授权连接 ChatCut 账号</button>
          </div>
        ...
        <div id="chatcutHint" class="hint" style="color:var(--text-faint); font-size:12px; margin-bottom:10px;">ChatCut 智能剪辑：视频剪辑唯一工具，提供 52 个剪辑工具及对话 / 语音 / 图片 / 文件上传四种剪辑方式</div>
