    ...
    $meta_boxes['email-settings'] = array(
        ...
        'fields' => apply_filters( 'gamipress_email_settings_fields', array(
            'email_template' => array(
                'name' => __( 'Email Template', 'gamipress' ),
                'tooltip'   => __( 'The email template to be used.', 'gamipress' ),
            ...
            'email_logo' => array(
                ...
                'tooltip'   => __( 'Upload, choose or paste the URL of the logo to be displayed at the top of the emails (not displayed in plain text template).', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'file',
            ),
            'email_from_name' => array(
                'name' => __( 'Name', 'gamipress' ),
                'tooltip'   => __( 'Name to display as sender.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'text',
                'default_cb' => 'gamipress_site_name_default_cb',
            ),
            'email_from_address' => array(
                'name' => __( 'Email Address', 'gamipress' ),
                'tooltip'   => __( 'This email address will be used as the "from" and "reply-to" address.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'text',
                'default' => get_bloginfo( 'admin_email' ),
            ),
            'email_footer_text' => array(
                'name' => __( 'Email Footer Text', 'gamipress' ),
                'tooltip'   => __( 'Text to be shown at email footer.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'desc' => gamipress_get_pattern_tags_html( 'email_footer' ),
                'type' => 'textarea',
    ...
    $meta_boxes['email-templates'] = array(
        ...
        'fields' => apply_filters( 'gamipress_email_templates_fields', array(
            ...
            'achievement_earned_email_actions' => array(
                ...
                'buttons' => array(
                    'achievement-earned-email-preview' => array(
                        'label' => gamipress_dashicon( 'visibility' ) . ' ' . __( 'Preview Email', 'gamipress' ),
                        'type' => 'link',
                        'link' => admin_url( 'admin.php?gamipress-action=preview_achievement_earned_email' ),
                        'target' => '_blank',
                    ),
                    'achievement-earned-email-send' => array(
                        'label' => gamipress_dashicon( 'email-alt' ) . ' ' . __( 'Send Test Email', 'gamipress' ),
                        'type' => 'link',
            ...
            'disable_achievement_earned_email' => array(
                'name' => __( 'Disable Emails', 'gamipress' ),
                'tooltip'   => __( 'Stop sending emails to users about new achievements earned.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'checkbox',
            ...
            'achievement_earned_email_subject' => array(
                ...
                'tooltip'   => __( 'Enter the subject line for the achievement earned email.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'text',
            ...
            'disable_step_completed_email' => array(
                'name' => __( 'Disable Emails', 'gamipress' ),
                'tooltip'   => __( 'Stop sending emails to users about new steps completed.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            'step_completed_email_subject' => array(
                'name' => __( 'Subject', 'gamipress' ),
                'tooltip'   => __( 'Enter the subject line for the step completed email.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'text',
            ...
            'disable_points_award_completed_email' => array(
                'name' => __( 'Disable Emails', 'gamipress' ),
                'tooltip'   => __( 'Stop sending emails to users about new points awards.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            'points_award_completed_email_subject' => array(
                'name' => __( 'Subject', 'gamipress' ),
                'tooltip'   => __( 'Enter the subject line for the points award email.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'text',
            ...
            'disable_points_deduct_completed_email' => array(
                'name' => __( 'Disable Emails', 'gamipress' ),
                'tooltip'   => __( 'Stop sending emails to users about new points deductions.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            'points_deduct_completed_email_subject' => array(
                'name' => __( 'Subject', 'gamipress' ),
                'tooltip'   => __( 'Enter the subject line for the points deduct email.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'text',
            ...
            'disable_rank_earned_email' => array(
                'name' => __( 'Disable Emails', 'gamipress' ),
                'tooltip'   => __( 'Stop sending emails to users about new ranks reached.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            'rank_earned_email_subject' => array(
                'name' => __( 'Subject', 'gamipress' ),
                'tooltip'   => __( 'Enter the subject line for the rank earned email.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'text',
            ...
            'disable_rank_requirement_completed_email' => array(
                'name' => __( 'Disable Emails', 'gamipress' ),
                'tooltip'   => __( 'Stop sending emails to users about new rank requirements completed.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            'rank_requirement_completed_email_subject' => array(
                'name' => __( 'Subject', 'gamipress' ),
                'tooltip'   => __( 'Enter the subject line for the rank requirement completed email.', 'gamipress' ),
                'label_cb' => 'cmb_tooltip_label_cb',
                'type' => 'text',
