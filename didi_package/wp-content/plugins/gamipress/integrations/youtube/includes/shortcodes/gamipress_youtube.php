    ...
    gamipress_register_shortcode( 'gamipress_youtube', array(
        ...
        'fields'      => array(
            'url' => array(
                ...
                'tooltip'   => __( 'The Youtube video URL or ID.', 'gamipress' ),
            ...
            'autoplay' => array(
                ...
                'tooltip'   => __( 'Check this option to automatically play the video.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type' 	    => 'checkbox',
            ...
            'controls' => array(
                ...
                'tooltip'   => __( 'Check this option to show player controls.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type' 	    => 'checkbox',
                'classes' 	=> 'gamipress-switch',
                'default' 	=> 'yes',
