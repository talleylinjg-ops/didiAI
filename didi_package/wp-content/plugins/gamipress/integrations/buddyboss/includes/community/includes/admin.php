    ...
    $meta_boxes['gamipress-bp-settings'] = array(
        ...
        'fields' => apply_filters( 'gamipress_bp_settings_fields', array(
            ...
            $prefix . 'points_placement' => array(
                ...
                'tooltip'   => __( 'Check the areas you wish to show the user points.', 'gamipress' ),
            ...
            $prefix . 'members_points_types' => array(
                ...
                'tooltip'   => __( 'Choose the points types you want to show.', 'gamipress' )
            ...
            $prefix . 'achievements_placement' => array(
                ...
                'tooltip'   => __( 'Check the areas you wish to show the user achievements.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'multicheck',
                'classes'   => 'gamipress-switch',
                'options'   => array(
            ...
            $prefix . 'members_achievements_types' => array(
                ...
                'tooltip'       => __( 'Choose the achievement types you want to show.', 'gamipress' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed.', 'gamipress' ),
                'label_cb'      => 'cmb_tooltip_label_cb',
                'type'          => 'multicheck',
            ...
            $prefix . 'ranks_placement' => array(
                ...
                'tooltip'   => __( 'Check the areas you wish to show the user ranks.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'multicheck',
                'classes'   => 'gamipress-switch',
                'options'   => array(
            ...
            $prefix . 'members_ranks_types' => array(
                ...
                'tooltip'   => __( 'Choose the rank types you want to show.', 'gamipress' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'multicheck',
            ...
            $prefix . 'members_ranks_top_title' => array(
                'name'      => __( 'Show Title', 'gamipress' ),
                'tooltip'   => __( 'Show the rank title.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
            ...
            $prefix . 'email_settings' => array(
                ...
                'tooltip'   => __( 'Display the GamiPress email settings in the user\'s email preferences.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
            $prefix . 'email_groups' => array(
                'name'      => __( 'Divide Email Settings By Group', 'gamipress' ),
                'tooltip'   => __( 'Display email settings divided by group.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
            $prefix . 'email_types' => array(
                'name'      => __( 'Divide Email Settings By Type', 'gamipress' ),
                'tooltip'   => __( 'Display email settings divided by type.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
    ...
    $meta_boxes['gamipress-bp-tab-settings'] = array(
        ...
        'fields' => apply_filters( 'gamipress_bp_tab_settings_fields', array_merge( array(
            ...
            $prefix . 'points_tab' => array(
                ...
                'tooltip'   => __( 'Show the user points on a profile tab.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
            $prefix . 'points_tab_title' => array(
                ...
                'tooltip'   => __( 'Text to show on the BuddyBoss user profile.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'text',
            ...
            $prefix . 'points_tab_slug' => array(
                ...
                'tooltip'   => __( 'URL slug to use on the profile tab. Leave blank and slug will be a URL version of the tab title (eg: "My Tab Title" will have a slug like "my-tab-title").', 'gamipress' )
            ...
            $prefix . 'tab_points_types' => array(
                'name'      => __( 'Points Types', 'gamipress' ),
                'tooltip'   => __( 'Choose the points types you want to show on BuddyBoss user profile.', 'gamipress' )
            ...
            $prefix . 'achievements_tab' => array(
                ...
                'tooltip'   => __( 'Show the user achievements on a profile tab.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
            ...
            $prefix . 'tab_achievements_types' => array(
                ...
                'tooltip'   => __( 'Choose the achievement types you want to show on BuddyBoss user profile achievements tab.', 'gamipress' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed on the profile.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'multicheck',
            ...
            $prefix . 'members_achievements_template_title' => array(
                ...
                'tooltip'   => __( 'Setup how achievements should look on the BuddyBoss user profile tab.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'title',
            ),
            ...
            $prefix . 'ranks_tab' => array(
                ...
                'tooltip'   => __( 'Show the user ranks on a profile tab.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
            ...
            $prefix . 'tab_ranks_types' => array(
                'name'      => __( 'Rank Types', 'gamipress' ),
                'tooltip'   => __( 'Choose the rank types you want to show on BuddyBoss user profile ranks tab.', 'gamipress' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed on the profile.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'multicheck',
            ...
            $prefix . 'members_ranks_template_title' => array(
                ...
                'tooltip'   => __( 'Setup how ranks should look on the BuddyBoss user profile tab.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'title',
            ),
    ...
    $meta_boxes['gamipress-bp-block-users-settings'] = array(
        ...
        'fields' => apply_filters( 'gamipress_bp_block_users_settings_fields', array(
            $prefix . 'blocked_member_types' => array(
                ...
                'tooltip'   => __( 'Block users earnings by profile type. Users with those profile types will not be able to earn any GamiPress element.', 'gamipress' )
                    . '<br>' . sprintf(
