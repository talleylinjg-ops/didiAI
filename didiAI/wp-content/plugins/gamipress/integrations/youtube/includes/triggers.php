...
function gamipress_youtube_log_extra_data_fields( $fields, $log_id, $type ) {
    ...
    switch( $trigger ) {
        ...
        case 'gamipress_youtube_watch_specific_video':
            ...
            $url = esc_url( 'https://www.youtube.com/embed/' . rawurlencode( $video_id ) );
            ...
            $fields[] = array(
                ...
                'id'   	            => $prefix . 'video_id',
                'type' 	            => 'html',
                'content'           => '<iframe id="youtube-player" type="text/html" src="' . esc_attr( $url ) . '" width="640" height="360" frameborder="0"></iframe>'
            );
            break;
    }
