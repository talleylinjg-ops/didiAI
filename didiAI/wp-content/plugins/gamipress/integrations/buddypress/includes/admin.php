    ...
    $meta_boxes['gamipress-bp-settings'] = array(
        ...
        'fields' => apply_filters( 'gamipress_bp_settings_fields', array(
            ...
            $prefix . 'points_placement' => array(
                ...
                'tooltip'   => __( 'Areas you wish to show the user points.', 'gamipress' ),
            ...
            $prefix . 'members_points_types' => array(
                ...
                'tooltip'   => __( 'Points types you want to show.', 'gamipress' )
            ...
            $prefix . 'achievements_placement' => array(
                ...
                'tooltip'   => __( 'Areas you wish to show the user achievements.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'multicheck',
                'classes'   => 'gamipress-switch',
                'options'   => array(
            ...
            $prefix . 'ranks_placement' => array(
                ...
                'tooltip'   => __( 'Areas you wish to show the user ranks.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'multicheck',
                'classes'   => 'gamipress-switch',
                'options'   => array(
            ...
            $prefix . 'email_settings' => array(
                ...
                'tooltip'   => __( 'Display the GamiPress email settings to the user\'s email preferences.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
            ),
    ...
    $meta_boxes['gamipress-bp-tab-settings'] = array(
        ...
        'fields' => apply_filters( 'gamipress_bp_tab_settings_fields', array_merge( array(
            ...
            $prefix . 'points_tab_title' => array(
                ...
                'tooltip'   => __( 'Text to show on the BuddyPress user profile.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'text',
            ...
            $prefix . 'tab_points_types' => array(
                'name'      => __( 'Points Types', 'gamipress' ),
                'tooltip'   => __( 'Points types you want to show on BuddyPress user profile.', 'gamipress' )
            ...
            $prefix . 'tab_achievements_types' => array(
                ...
                'tooltip'   => __( 'Achievement types you want to show on BuddyPress user profile achievements tab.', 'gamipress' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed on the profile.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type' => 'multicheck',
            ...
            $prefix . 'tab_ranks_types' => array(
                'name'      => __( 'Rank Types', 'gamipress' ),
                'tooltip'   => __( 'Rank types you want to show on BuddyPress user profile ranks tab.', 'gamipress' )
                    . '<br>' . __( '<strong>Note:</strong> You can drag and drop this options to reorder them. The order you set will affect to the order they will get displayed on the profile.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'multicheck',
