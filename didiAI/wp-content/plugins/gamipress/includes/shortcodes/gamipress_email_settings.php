...
function gamipress_register_email_settings_shortcode() {
    ...
    gamipress_register_shortcode( 'gamipress_email_settings', array(
        ...
        'fields'      => array(
            'groups' => array(
                'name'      => __( 'Divide by group', 'gamipress' ),
                'tooltip'   => __( 'Show email settings divided by group.', 'gamipress' ),
            ...
            'types' => array(
                'name'      => __( 'Divide by type', 'gamipress' ),
                'tooltip'   => __( 'Show email settings divided by type.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
                'default'   => 'yes',
            ...
            'current_user' => array(
                ...
                'tooltip'   => __( 'Show the email settings of the current logged in user.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'checkbox',
                'classes'   => 'gamipress-switch',
                'default'   => 'yes',
            ...
            'user_id' => array(
                ...
                'tooltip'   => __( 'Show the email settings of a specific user.', 'gamipress' ),
                'label_cb'  => 'cmb_tooltip_label_cb',
                'type'      => 'select',
                'default'   => '',
